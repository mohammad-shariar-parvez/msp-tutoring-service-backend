...
CREATE TYPE "CourseStatus" AS ENUM ('RUNNING', 'UPCOMMING');
...
ALTER TABLE "courses"
ADD
    CONSTRAINT "courses_courseTutorId_fkey" FOREIGN KEY ("courseTutorId") REFERENCES "courseTutors"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE
    "review_and_rating"
ADD
    CONSTRAINT "review_and_rating_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "courses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE
    "review_and_rating"
ADD
    CONSTRAINT "review_and_rating_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey

ALTER TABLE "bookings"
ADD
    CONSTRAINT "bookings_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "courses"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
