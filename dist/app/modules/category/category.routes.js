...
router.post('/', (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(category_validations_1.CategoryValidations.create), category_controller_1.ServiceController.insertIntoDB);
